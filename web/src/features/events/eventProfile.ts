...
const EVENT_PROFILE_SCALE_DEFINITIONS: readonly EventProfileScaleDefinition[] = [
  {
    ...
    questionKeys: ["core_vision_ambition"],
  ...
  {
    key: "tempo",
    label: "Tempo & Intensitaet",
    questionKeys: ["core_execution_tempo", "core_vision_time_horizon"],
    lowLabel: "spuerbar, aber mit Luft",
    balancedLabel: "mit Zug und klarer Prioritaet",
    highLabel: "sehr intensiv und all-in",
  },
  {
    key: "risk",
