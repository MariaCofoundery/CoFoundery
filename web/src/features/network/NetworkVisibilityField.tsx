...
import type { NetworkVisibility } from "./networkTypes";
...
export function NetworkVisibilityField({ initial = "members_only", copy }: { initial?: NetworkVisibility; copy: Copy }) {
  const [visibility, setVisibility] = useState<NetworkVisibility>(initial);
