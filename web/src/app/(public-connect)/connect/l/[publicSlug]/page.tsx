...
import { getPublicConnectListing, publicConnectPhotoUrl } from "@/features/connect/publicConnectData";
...
export default async function PublicConnectListingPage({ params }: { params: Promise<{ publicSlug: string }> }) {
  ...
  const photo = listing.owner_photo_available ? publicConnectPhotoUrl("listing", listing.public_slug, listing.updated_at) : null;
